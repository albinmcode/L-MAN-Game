...
public:
	// Default constructor
	EnemyUI(Vector2f spawnPoint, const std::string& textureFile,const std::string& vulnerableTexture, std::int32_t corx, std::int32_t cory, EntityUI& target); //Initializes the resources and positions needed for the enemy
